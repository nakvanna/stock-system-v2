<template>
  <ejs-grid
    ...
    :allowPaging='true'
    :pageSettings='gridOption.pageSettings'
  >
    <slot/>
  </ejs-grid>
</template>
...
import {Aggregate, DetailRow, Filter, GridPlugin, Group, Page, Resize, Sort, Toolbar} from "@syncfusion/ej2-vue-grids";
import Vue from "vue";
...
export default {
  ...
  setup(props: any, {emit, root}: any) {
    ...
    const gridOption = reactive({
      ...
      pageSettings: {pageSizes: [15, 50, 100, 200, 300], pageCount: 10},
  ...
  provide: {
    grid: [Filter, Sort, Toolbar, Resize, DetailRow, Group, Aggregate, Page]
  },
}
</script>
<style scoped>
